...
//	public static void adicionarIdentificacao(JFrame janela, int id) {
//		
...
//
//		adicionarJLabel(janela, "<html><u>"+funcionarioDTO.getCargo()+" ("+funcionarioDTO.getNome()+" : "+funcionarioDTO.getId()+")</u></html>", 5, 5, 1000, 25);
//	}
...
//	public static JScrollPane adicionarJtextArea(JFrame janela, int x, int y, int c, int a ) {
